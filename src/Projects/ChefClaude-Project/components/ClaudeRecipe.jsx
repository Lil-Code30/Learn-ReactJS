export default function ClaudeRecipe({ getRecipeFromMistral, ingredients }) {
  return getRecipeFromMistral(ingredients);
}

// <section className="w-2/3 mx-auto mt-10">
//   <h2 className="text-3xl font-Inter font-bold my-2 text-[#141413]">
...
//       the recipe:
//     </p>
//     <h3 className="text-2xl font-Inter font-bold my-2 text-[#141413]">
//       Beef Bolognese Pasta
//     </h3>
//     <strong className="text-xl font-Inter font-bold my-2 text-[#141413]">
//       Ingredients:
//     </strong>
...
//       Instructions:
//     </strong>
//     <ol className="mb-5 list-inside list-disc">
